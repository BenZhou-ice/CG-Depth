...
def parse_args():
    ...
    # decoder
    parser.add_argument("--use_bra",
                        help="if set, use bra",
                        default=False,
                        action="store_true")

    parser.add_argument("--use_moga",
                        help="if set, use moga",
                        default=False,
                        action="store_true")

    parser.add_argument("--use_cga",
                        help="if set, use cga",
                        default=True,
                        action="store_true")

    parser.add_argument("--use_wtdown",
...
def test_simple(args):
    ...
    if args.x:
        encoder = networks.ResnetEncoder(50,
                                         False,
    ...
    if args.update == 3:
        depth_decoder = R_MSFM3(args.x,
                                use_moga=args.use_moga,
                                use_cga=args.use_cga,
                                use_wtdown=args.use_wtdown,
                                use_bra=args.use_bra
                                )
    else:
