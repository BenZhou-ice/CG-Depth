...
def main():
    ...
    print("Output shape (FFT2):", output_fft2.shape, output_fft2)
    out_img = output_fft2.detach().numpy().squeeze(0)
    # 使用数组的 .transpose() 方法改变维度顺序
